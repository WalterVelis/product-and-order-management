...
class AdminController extends Controller
{
    ...
    public function store (AdminRequest $request)
    {
        ...
        if(Input::hasfile('avatar')){
            ...
            $file->move(public_path().'/img/admins',Carbon::now()->second.$file->getClientOriginalName());
            $admin->avatar=Carbon::now()._.$file->getClientOriginalName();
        }
    ...
    public function update(AdminRequest $request,$id)
    {
        ...
        if(Input::hasfile('avatar')){
            ...
            if(strcmp($oldavatar,'admin_default.png')){
                if(is_file(public_path().'/img/admins/'.$oldavatar)){
                    unlink(public_path().'/img/admins/'.$oldavatar);
                } 
            }
            $file->move(public_path().'/img/admins',Carbon::now()->second.$file->getClientOriginalName());
